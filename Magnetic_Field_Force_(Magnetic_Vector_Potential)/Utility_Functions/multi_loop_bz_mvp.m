function bz = multi_loop_bz_mvp(r,z,radius_initial,I,dw,Npl,Nl)
% Calculate Bz of a multi loop using Magnetic Vector Potential Method
...
for m=1:Nl
    ...
    for n=1:Npl
        ...
        bz=bz+single_loop_bz_mvp(r,zz,Rm,I);
    end
end
