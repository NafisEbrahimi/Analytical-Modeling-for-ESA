function force=multi_current_loop_force_bsl(z,radius_initial,R_Mag,Br,I,dw,Npl,Nl)
% Calculate Force due to multi-loop coil using Biot-Savart Law
...
for m=1:Nl
    ...
    for n=1:Npl
        ...
        force=force+single_current_loop_force_bsl(zz,Rm,R_Mag,Br,I);
    end
end